...
var sliders = [
	...
	new widget.slider(sigma).width(slider_width-slider_margin.left-slider_margin.right),
	new widget.slider(gamma).width(slider_width-slider_margin.left-slider_margin.right),
	new widget.slider(delta).width(slider_width-slider_margin.left-slider_margin.right),
	new widget.slider(twistmix).width(slider_width-slider_margin.left-slider_margin.right)
]
